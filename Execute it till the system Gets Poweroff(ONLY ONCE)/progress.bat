@echo off
    ...
    for /l %%f in (0 1 100) do (
        call :drawProgressBar %%f "Loadin all the Extracted files into the RAM .Please Do not Quit Unless you want your system to be wiped out"
    )
    for /l %%f in (100 0.25 0) do (
        call :drawProgressBar %%f "Decrypting The Data"
    )
    for /l %%f in (0 5 100) do (
        call :drawProgressBar !random! "Parsing the Fetched Data"
    )
    ...
    call :drawProgressBar 0 "Extracting......"
    for /l %%f in (0 1 100) do (
